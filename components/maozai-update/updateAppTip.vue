<template>
	<view class="z-index row" v-if="is_update_app">111
		<view class="update-box flex-column">
			<view class="box-font-box flex-column">
				<view class="box-title">{{update_title}}</view>
				<scroll-view class="box-des-scroll" scroll-y="true">
					<view class="box-des" v-for="(item,index) in update_des" :key="index">{{item}}</view>
				</scroll-view>
			</view>
